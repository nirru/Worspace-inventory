...
import anteeo.com.pl.zoltansport.SearchViewActivity;
import anteeo.com.pl.zoltansport.Singleton;
...
public class ScannerActivity extends ActionBarActivity implements
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		// menuItem = menu.add(Menu.NONE, R.id.menu_formats, 0,
		// R.string.formats);
	...
	public void handleResult(Result rawResult) {
		...
		showOKAleart(ScannerActivity.this, "Message", rawResult.getText()
				.toString().trim());
	}
	...
	public void showOKAleart(Context context, String title,
...
//				alertDialog.dismiss();
//				Intent i = new Intent(ScannerActivity.this, SearchViewActivity.class);
//				i.putExtra(AppConstant.BARCODE, message);
//				startActivity(i);
//				finish();
//			}
//		});
